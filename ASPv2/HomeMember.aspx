<%@ Page Title="" Language="C#" MasterPageFile="~/MasterMember.master" AutoEventWireup="true" CodeFile="HomeMember.aspx.cs" Inherits="HomeMember" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <p>
        <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Italic="True" 
            Font-Size="30pt" ForeColor="#FFCCFF" Text="Welcome"></asp:Label>
        &nbsp;&nbsp;&nbsp;&nbsp;<asp:Label ID="lblName" runat="server" Font-Size="30pt" Font-Underline="True" 
            ForeColor="#FFCCFF" Font-Bold="False" Font-Italic="True">Member</asp:Label>
</p>
    <p>
        &nbsp;</p>
    <p>
        <asp:Label ID="Label2" runat="server" ForeColor="#FFCCFF" 
...
<table class="style1" align="center">
        ...
        <tr>
            <td style="text-align: center">
                <asp:Label ID="Label4" runat="server" Text="English" Font-Bold="True" 
                    Font-Size="Large" ForeColor="White"></asp:Label>
            </td>
            <td style="text-align: center">
                <asp:Label ID="Label5" runat="server" Text="Math" Font-Bold="True" 
                    Font-Size="Large" ForeColor="White"></asp:Label>
            </td>
            <td style="text-align: center">
